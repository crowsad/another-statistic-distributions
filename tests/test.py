...
#  pip install --upgrade another_statistic_distributions
...
from another_statistic_distributions import Gaussian
from another_statistic_distributions import Binomial
